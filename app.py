...
/* 1. Agresivní cíl pro odstranění rámečků z obalů st.table */
div[data-testid="stTable"] {{
    box-shadow: none !important;
    border: none !important;
}}

/* 2. Stylování samotné tabulky vložené do wrapperu .dark-table */
...
.dark-table table {{
    ...
    border-radius: 0px !important;
    border: none !important;
    border-collapse: collapse; /* Zajišťuje ostré hrany */
}}
